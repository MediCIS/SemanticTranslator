...
public class TranslateDicomData extends OntologyPopulator {
	...
	public static void TranslateSR(ContentItem e) throws IOException {
		...
		case "X-Ray_Modulation_Type":
			i = createIndiv(generateName("X-Ray_Modulation_Type"), getResource("http://dicom.nema.org/resources/ontology/DCM/113842"));
		...
		case "Exposed_Range":
			i = createIndivWithUnit(value, "Exposed_Range", racineDCM+"113899", scanningLength, getURI("has_measure")); // relier à l'acquisition
